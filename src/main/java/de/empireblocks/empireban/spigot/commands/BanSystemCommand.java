...
public class BanSystemCommand implements CommandExecutor {
    ...
    private void showId(CommandSender sender, String key) {
        ...
        sender.sendMessage(core.getMessagesManager().get("ids.show-line", Map.of(
        ...
        for (IdLevel level : banId.getLevels()) {
            sender.sendMessage(core.getMessagesManager().get("ids.show-level", Map.of(
    ...
    // /bansystem ids edit <ID> add lvl <Duration> <Type>
    // /bansystem ids edit <ID> remove lvl <lvl>
    // /bansystem ids edit <ID> set lvlduration <lvl> <Duration>
    // /bansystem ids edit <ID> set lvltype <lvl> <Type>
    // /bansystem ids edit <ID> set onlyadmins <True/False>
